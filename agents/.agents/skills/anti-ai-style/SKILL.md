...
Antes de revisar o redactar, abre el fichero de la familia que corresponda al tipo de problema detectado. Cada fichero desarrolla los patrones con ejemplos y reglas operativas.
...
| [`revision-y-checklist.md`](revision-y-checklist.md) | Revisión de un texto completo: reglas generales, checklist de 25 puntos, regla final de calidad |
