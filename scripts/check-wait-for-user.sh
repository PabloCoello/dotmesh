...
require_text "agents/.agents/skills/README.md" 'Estas 15 skills forman el conjunto base de ingeniería:'
require_text "README.md" 'El core pack diario incluye 15 skills de ingeniería:'
