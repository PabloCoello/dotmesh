...
traducido a configuración real: tema de VS Code, tema de Ghostty,
...
| Multiplexor | [`herdr/.config/herdr/config.toml`](../herdr/.config/herdr/config.toml) | cromo de herdr: sidebar Ink-1 sobre los paneles Ink-0, texto en tres escalones de grafito (`#cecece` · `#9e9e9e` · `#767676`), teal reservado al acento y estados de agente como señal (rose blocked · gold working · sage done · grafito idle) |
