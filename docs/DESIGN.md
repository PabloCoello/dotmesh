...
| Revisión | [`vscode/review-extension/`](../vscode/review-extension/) | fondo `rgba(32,32,32,0.3)` (ink-2 con alpha, compatible con tema claro) en el rango anclado; etiqueta de prioridad al final de línea (rose `#E59A9A` alta · gold `#E3C58A` media · teal `#6CB6B0` baja); `#6e6e6e` en comentarios resueltos |
